  ...
  Future<List<Song>> searchSongs(String keyword) async {
    ...
    return [
      const Song(
        ...
        href: "/music/11561889",
        playUrl:
            "https://lv-sycdn.kuwo.cn/532e444177f4ac306169d2c14d23ae76/6888d10d/resource/30106/trackmedia/M500003KtYhg4frNXC.mp3?bitrate\$128&from=vip",
      ),
      const Song(
        id: "11561895",
        title: "枫",
      ...
      const Song(
        ...
        href: "/music/11561890",
        playUrl:
            "https://gg-sycdn.kuwo.cn/3a3cb1c5b3731d07a5dd959e1d435354/68859e3f/resource/n1/48/12/2278260523.mp3?bitrate\$128&from=vip",
      ),
      const Song(
        id: "11561892",
        title: "枫(片段)",
        ...
        href: "/music/11561892",
        playUrl:
            "https://er-sycdn.kuwo.cn/ff4c99c311a4014fb7aa7add4fe4dc59/68859e41/resource/30106/trackmedia/M500000zKujF0Yh5vV.mp3?bitrate\$128&from=vip",
      ),
    ];
  }
}
